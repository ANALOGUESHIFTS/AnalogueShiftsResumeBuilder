...
export default function Finalize() {
  ...
  // Updating the Value Of an award
  ...
  // Updating the Value Of a publication
  ...
  // Updating the Value Of an customData Name
  ...
  // Updating the Value Of an customData Description
