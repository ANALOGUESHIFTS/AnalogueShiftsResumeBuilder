...
import UseOurBuilder from "../components/UseOurBuilder";
import HowOurCoverLetterBuilderWorks from "../components/HowOurCoverLetterBuilderWorks";
import CoverLetterSamples from "../components/CoverLetterSamples";
...
export default function Page() {
  ...
  const serviceData = [
    ...
    },
    {
      ...
      subTitle: (
        <p className="text-black/60 max-[1050px]:text-center font-normal tracking-normal text-base pl-2">
          Our software pulls information from real job advertisements, then
          parses & rewrites it to create compelling sentences for your
          personalized letter.
        </p>
      ),
    ...
    },
    {
      ...
      subTitle: (
        <p className="text-black/60 max-[1050px]:text-center font-normal tracking-normal text-base pl-2">
          Every part of our builder (from the templates to the content
          generator) was developed to bypass software companies use to filter
          out candidates.
        </p>
      ),
