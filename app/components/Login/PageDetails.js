...
export default function LoginPageDetails() {
  ...
  return (
    <main className="w-screen overflow-y-auto h-[calc(100px+90vh)] overflow-x-hidden min-h-screen fixed top-0 left-0 bg-[#f0f0f0] z-80 flex flex-col items-center  gap-[70px] py-[70px]">
      <ApplicationLogo />
