...
export default function ViewTemplateModal({ data, closeModal, builder }) {
  return (
    <div className="fixed top-0 left-0 max-[552px]:px-0 max-[552px]:py-0  bg-black/10 z-90 overflow-y-auto w-screen h-screen px-20 py-8 max-[972px]:px-10 max-[691px]:px-7">
      <button
        onClick={closeModal}
