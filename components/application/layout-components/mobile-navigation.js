...
import resumeTemplates from "@/resources/navigation/resume-templates.json";
import coverLetterTemplates from "@/resources/navigation/cover-letter-templates.json";
import faqs from "@/resources/navigation/faqs.json";
    ...
    >
      {navLinks.map((data) => {
        if (selectedMobileMenu === "" || selectedMobileMenu === data) {
          return (
            <div
              onClick={() => updateSelectedMenu(data)}
